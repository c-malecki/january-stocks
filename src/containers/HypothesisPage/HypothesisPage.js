    ...
    <div className="hypothesis">
      ...
      <div>
        <p>
          ...
          some intra-day breaks lately for some of these stocks, but they still seem to settle into
          some form of correlation. For example, AMC broke the trend at the end of May and for the
          first couple days of June, running up to as high as $70 while none of these others had
          ...
          recently had a bit of a breakout movement, though no where near as dramatic as AMC.
          Shortly after, BBBY had a jump as well.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            Institutions would have a better idea of why the stock is moving than the insiders due
            to market technicals. So more ownership = more risk, but insider ownership = less risk
          ...
          <li>
            ...
            float, the more trades in the hands of retail. It's easier to get away with shorting
            since retail would likely just sell out of fear without really knowing or caring why the
            stock is losing value.
          </li>
        </ul>
        <p>
          So if a good target is identified and assessed, the next step would be identifying sources
          available to short it with. The more sources, the more potential shorting. How much to
          short it would be determined by the overall assessment and risk model result.
        </p>
        <p>
